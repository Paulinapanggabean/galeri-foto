...
<div class="container">
    <div class="row">
        <div class="col-md-4">
          <div class="card mt-2">
          <div class="card-header bg-dark-subtle">Tambah Foto</div>
          <div class="card-body">
    ...
    <div class="col-md-8">
      <div class="card mt-2">
      <div class="card-header bg-dark-subtle">Data Galeri Foto</div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                      ...
                      <div class="modal-content">
                        ...
                        <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <select class="form-control" name="albumid">
                                                            ...
                                                            $sql_album = mysqli_query($koneksi, "SELECT * FROM album  WHERE userid='$userid'");
                                                            while($data_album = mysqli_fetch_array($sql_album)){ ?>
                                                            <option <?php if ($data_album['albumid'] == $data['albumid']) { ?> selected="selected" <?php } ?> value="<?php echo $data_album['albumid'] ?>"><?php echo $data_album['namaalbum'] ?></option>  ></option> 
                                                            <?php } ?> 
                                                            </select>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
   <p>&copy; UKK RPL 2024 | Paulina Panggabean</p>
</footer>
</div>
