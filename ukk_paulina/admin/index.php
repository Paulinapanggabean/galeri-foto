...
<body>
  ...
  <div class="container-fluid bg-danger-subtle p-3 mb-2 mt-3">
    <div class="row">
      <?php
          ...
          <div class="col-md-4">
            <div class="m-2">
              <div class="overflow-auto">
                ...
                <a href="../assets/img/<?php echo $data['lokasifile']?>" download="download"><i class="fa-regular fa-circle-down"></i></a>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
    <p>&copy; UKK RPL 2 2024 || Paulina Panggabean</p>
</footer>
