...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <div class="card mt-2">
        <div class="card-header bg-dark-subtle">Tambah Album</div>
        <div class="card-body">
    ...
    <div class="col-md-8">
      <div class="card mt-2">
        <div class="card-header bg-dark-subtle">Data Album</div>
        <div class="card-body">
          <table class="table">
            <thead>
              <tr>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="../config/aksi_album.php" method="POST">
                             <input type="hidden" name="albumid" value="<?php echo $data['albumid'] ?>">
                             Apakah anda yakin akan menghapus album <strong> <?php echo $data['namaalbum'] ?> </strong> ?
